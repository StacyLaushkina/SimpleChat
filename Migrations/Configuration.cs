...
namespace SimpleChat.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SimpleChat.DAL.SiteContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "SimpleChat.DAL.SiteContext";
        }

        protected override void Seed(SimpleChat.DAL.SiteContext context)
        {
